      ...
      \begin{itemize}[label={}, leftmargin=0pt]
            \begin{item}
                  ...
                  \begin{itemize}[label={$\bullet$}, leftmargin=12.5pt, noitemsep]
                        \begin{item}
                              ...
                              \begin{itemize}[label={-}, leftmargin=20pt, noitemsep]
                                    \begin{item}
                                          Designed and implemented a resilient event-driven architecture supporting high-volume, low-latency data flows using \href{https://grpc.io/}{gRPC}, advanced concurrency models, and distributed processing
                                    \end{item}
                                    \begin{item}
                                    ...
                                    \end{item}
                                    \begin{item}
                                          Added full \href{https://microsoft.github.io/language-server-protocol/}{Language Server Protocol (LSP)} support, improving developer experience and enabling richer ecosystem tooling
                                    \end{item}
                                    \begin{item}
                        ...
                        \end{item}
                        \begin{item}
                              Architected and automated CI/CD pipelines and the end-to-end SDLC workflow, improving deployment reliability, reducing release times, and enabling continuous delivery across multiple services
                        \end{item}
                        \begin{item}
                  ...
                  \begin{itemize}[label={$\bullet$}, leftmargin=12.5pt, noitemsep]
                        ...
                        \end{item}
                        \begin{item}
                              Developed and maintained 20+ core libraries powering the company's internal toolchain, establishing shared abstractions, coding standards, and scalable development practices
                        \end{item}
                  \end{itemize}
            \end{item}
            \begin{item}
