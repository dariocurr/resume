...
\begin{justify}
	...
	\hspace{0.1cm}
	\href{https://scholar.google.it/citations?hl=en&user=DhJKkeMAAAAJ}{\includesvg[width=0.5cm,height=0.5cm]{./assets/img/graduation_cap.svg}}
	\hspace{0.1cm}
	...
	\begin{itemize}[label={}, leftmargin=0pt]
		\begin{item}
		      ...
		      \vspace{0.05cm}
		      \\
		      Double Master achieved cum laude with final thesis about \href{https://dariocurr.github.io/assets/doc/master_thesis.pdf}{RDF data and columnar formats}
		      \\
